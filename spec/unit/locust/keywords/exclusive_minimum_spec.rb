RSpec.describe Locust::Keywords::ExclusiveMinimum do
  ...
  let(:source)  { true }
  let(:parent) do
    Locust::Keywords::Object.call({ type: "number", minimum: 10 }, nil)
  end
  ...
  describe "#validate" do
    ...
    context "when parent describes an integer" do
      let(:parent) do
        Locust::Keywords::Object.call({ type: "integer", minimum: 3 }, nil)
      end
    ...
    context "when parent describes neither integer nor a number" do
      let(:parent) do
        Locust::Keywords::Object.call({ type: "string", minimum: 3 }, nil)
      end
