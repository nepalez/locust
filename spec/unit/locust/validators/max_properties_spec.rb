RSpec.describe Locust::Validators::MaxProperties do
  ...
  describe "#errors" do
    ...
    context "when number of object properties doesn't exceed the limit" do
      let(:object) { { a: 1, b: 2, c: 3 } }
      it { is_expected.to be_empty }
    end

    context "when number of object properties exceeds the limit" do
      let(:object) { { a: 1, b: 2, c: 3, d: 3 } }
