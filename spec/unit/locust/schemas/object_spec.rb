RSpec.describe Locust::Schemas::Object do
  ...
  describe "additional_properties" do
    ...
    it { is_expected.to be_a Locust::Schemas::AdditionalProperties }
  ...
  describe "all_of" do
    ...
    it { is_expected.to be_a Locust::Schemas::AllOf }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "items" do
    ...
    it { is_expected.to be_a Locust::Schemas::Items }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "enum" do
    ...
    it { is_expected.to be_a Locust::Schemas::Enum }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "exclusive_maximum" do
    ...
    it { is_expected.to be_a Locust::Schemas::ExclusiveMaximum }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "exclusive_minimum" do
    ...
    it { is_expected.to be_a Locust::Schemas::ExclusiveMinimum }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "format" do
    ...
    it { is_expected.to be_a Locust::Schemas::Format }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "max_items" do
    ...
    it { is_expected.to be_a Locust::Schemas::MaxItems }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "max_properties" do
    ...
    it { is_expected.to be_a Locust::Schemas::MaxProperties }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "maximum" do
    ...
    it { is_expected.to be_a Locust::Schemas::Maximum }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "min_items" do
    ...
    it { is_expected.to be_a Locust::Schemas::MinItems }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "min_properties" do
    ...
    it { is_expected.to be_a Locust::Schemas::MinProperties }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "minimum" do
    ...
    it { is_expected.to be_a Locust::Schemas::Minimum }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "properties" do
    ...
    it { is_expected.to be_a Locust::Schemas::Properties }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "required" do
    ...
    it { is_expected.to be_a Locust::Schemas::Required }
    its(:parent) { is_expected.to eq schema }
  ...
  describe "type" do
    ...
    it { is_expected.to be_a Locust::Schemas::Type }
    its(:parent) { is_expected.to eq schema }
